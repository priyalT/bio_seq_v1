...
@given(
    k=st.integers(min_value=1, max_value=5), seq=st.text(alphabet="ACGT", min_size=5)
)
...
@given(
    motif_char=sampled_from(list(MotifFinder.IUPAC.keys())),
    base=sampled_from(list("ACGT")),
)
